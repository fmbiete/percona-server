...
static MYSQL_SYSVAR_STR(
    ...
    PLUGIN_VAR_RQCMDARG | PLUGIN_VAR_MEMALLOC, "The custom group search filter",
    nullptr /* check */, &update_sysvar<char *> /* update */,
    "(|(&(objectClass=posixGroup)(memberUid={UA}))(&(objectClass=group)(member="
    "{UD})))" /* default */);
